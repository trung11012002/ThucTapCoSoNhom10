        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            <ul class="navbar-nav m-auto">
                ...
                <c:if test="${sessionScope.acc.isAdmin == 1}">
                    <li class="nav-item">
                        <a class="nav-link" href="Manage.jsp" target="_blank">Manage</a>
                    </li>  
                </c:if>  
            ...
            <form action="search" method="post" class="form-inline my-2 my-lg-0">
                ...
                <a class="btn btn-success btn-sm ml-3" href="showcart">
                    ...
                    <span class="badge badge-light">${requestScope.sizeCart}</span>                   
                </a>
                <c:if test="${sessionScope.acc != null}">
                    <div class="user">
                        <div class="user__content">
                            ...
                            <ul class="user__menu">
                                ...
                                <li><a href="buyorder">Buy order</a></li>
...
<section class="jumbotron text-center">
    <div class="container">
        <h1 class="jumbotron-heading">High-end phone supermarket</h1>
