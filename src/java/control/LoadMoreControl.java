...
public class LoadMoreControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        List<Product> listP = dao.getNext6Product(amount);
        PrintWriter out = response.getWriter();

        for (Product o : listP) {
            String space = "";
            String cnt = o.getProduct_id() + "";
            if (o.getQuantity() <= 0) {
                space = "<div class=\"col\">\n"
                ...
                space = "<div class=\"col\">\n"
                        ...
                        + "                                                </div>\n"
                        + "                                                <div class=\"col\">\n"
                        + "                                                    <a href=\"cartcontrol?id=cnt&num=1\" class=\"btn btn-success btn-block\">Add to cart</a>\n"
                        + "                                                </div>";
            }
            out.println("<div class=\"product col-12 col-md-6 col-lg-4\">\n"
                    ...
                    + "                                    <div class=\"card-body\">\n"
                    + "                                        <h4 class=\"card-title show_txt\"><a href=\"detail?product_id=" + o.getProduct_id() + "\" title=\"View Product\">" + o.getName() + "</a></h4>\n"
                    + "                                        <div class=\"row\">\n"
                    + "                                            <div class=\"col\">\n"
